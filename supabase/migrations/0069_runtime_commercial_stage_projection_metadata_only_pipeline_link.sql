-- Keep the legacy pipeline linkage for stages in metadata only. The
-- commercial.pipeline_stages table stores legacy_stage_id but does not have a
-- legacy_pipeline_id column.
