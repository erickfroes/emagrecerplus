drop function if exists public.upsert_runtime_patient_from_legacy(uuid, text, text, text, date, text, text, text, text, text, jsonb);
drop function if exists api.upsert_runtime_patient_from_legacy(uuid, text, text, text, date, text, text, text, text, text, jsonb);
...
revoke all on function api.upsert_runtime_patient_from_legacy(text, text, text, text, date, text, text, text, text, text, jsonb) from public, anon, authenticated;
grant execute on function api.upsert_runtime_patient_from_legacy(text, text, text, text, date, text, text, text, text, text, jsonb) to service_role;
...
revoke all on function public.upsert_runtime_patient_from_legacy(text, text, text, text, date, text, text, text, text, text, jsonb) from public, anon, authenticated;
grant execute on function public.upsert_runtime_patient_from_legacy(text, text, text, text, date, text, text, text, text, text, jsonb) to service_role;
