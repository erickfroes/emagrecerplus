...
revoke all on function public.backfill_runtime_scope(text, text, text, text, text, jsonb) from public, anon, authenticated;
revoke all on function public.backfill_runtime_reference_data(uuid, jsonb, jsonb, jsonb) from public, anon, authenticated;
revoke all on function public.backfill_runtime_patient_domain(uuid, jsonb, jsonb, jsonb, jsonb) from public, anon, authenticated;
revoke all on function public.backfill_runtime_scheduling_domain(uuid, jsonb) from public, anon, authenticated;
revoke all on function public.backfill_runtime_clinical_domain(uuid, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb) from public, anon, authenticated;
revoke all on function public.backfill_runtime_patient_logs(uuid, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb) from public, anon, authenticated;

grant execute on function public.backfill_runtime_scope(text, text, text, text, text, jsonb) to service_role;
grant execute on function public.backfill_runtime_reference_data(uuid, jsonb, jsonb, jsonb) to service_role;
grant execute on function public.backfill_runtime_patient_domain(uuid, jsonb, jsonb, jsonb, jsonb) to service_role;
grant execute on function public.backfill_runtime_scheduling_domain(uuid, jsonb) to service_role;
grant execute on function public.backfill_runtime_clinical_domain(uuid, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb) to service_role;
grant execute on function public.backfill_runtime_patient_logs(uuid, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb) to service_role;
